...
// const checkIsMember = <T>(mem: T, arr: T[]) => {
//   for (let i = 0; i < arr.length; i++) {
//     if (arr[i] === mem) {
//       return true;
//     }
...
// console.log(checkIsMember(5, [1, 3, 7, 12]));
// console.log(checkIsMember("john", ["jane", "jim", "john"]));
// console.log(checkIsMember(true, [false, false]));

// type isMemberFunc = <T>(mem: T, arr: T[]) => boolean;

// const checkIsMember: isMemberFunc = (mem, arr) => {
//   for (let i = 0; i < arr.length; i++) {
//     if (arr[i] === mem) {
//       return true;
//     }
